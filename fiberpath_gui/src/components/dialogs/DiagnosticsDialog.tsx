      ...
      <div className="diagnostics-section">
        ...
        <div className="diagnostics-grid">
          ...
          <div className="diagnostics-item">
            ...
            <span className="diagnostics-value">{cliVersion || "Unknown"}</span>
          </div>
        ...
        <button className="btn btn--secondary diagnostics-refresh-btn" onClick={refresh}>
          Refresh CLI Status
        </button>
      </div>
      ...
      <div className="diagnostics-section">
        ...
        <div className="diagnostics-grid">
          ...
          <div className="diagnostics-item">
            ...
            <span className="diagnostics-value">{diagnostics.projectStats.layers}</span>
          </div>
          <div className="diagnostics-item">
      ...
      <div className="diagnostics-section">
        ...
        <div className="diagnostics-grid">
          <div className="diagnostics-item">
            ...
            <span className="diagnostics-value">{diagnostics.recentFilesCount} / 10</span>
          </div>
          <div className="diagnostics-item">
