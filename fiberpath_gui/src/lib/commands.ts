...
export async function previewPlot(inputPath: string, scale: number, outputPath?: string) {
  return invoke<PlotPreviewPayload>("plot_preview", {inputPath, scale, outputPath});
}
